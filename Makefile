...
amazon.o: amazon.cpp db_parser.h datastore.h product_parser.h book.o clothing.o movie.o
...
book.o: book.cpp product.cpp book.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c book.cpp
clothing.o: clothing.cpp product.cpp clothing.h
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c clothing.cpp
movie.o: movie.cpp product.cpp movie.h
